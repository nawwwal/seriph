...
const reason = (item: ImportBatchChild) => {
  ...
  return typeof value === 'string' && value ? value : 'Unresolved import';
};
...
export default function UploadReviewPanel({ batchId, families = [], reviewItems, actions, onInspect }: UploadReviewPanelProps) {
