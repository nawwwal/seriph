...
const ANALYSIS_STEPS: Record<AnalysisState, { label: string; icon: React.ReactNode }> = {
  not_started: {
    label: 'Not Started',
    icon: <Hourglass className="opacity-40" size={16} />,
  },
  queued: {
    label: 'Queued',
    icon: <Hourglass className="text-[var(--info)] animate-spin" size={16} />,
  },
  analyzing: {
    label: 'Analyzing',
    icon: <Loader2 className="text-[var(--info)] animate-spin" size={16} />,
  },
  enriching: {
    label: 'Enriching',
    icon: <Loader2 className="text-[var(--accent)] animate-spin" size={16} />,
  },
  complete: {
    label: 'Complete',
    icon: <CheckCircle2 className="text-[var(--success)]" size={16} />,
  },
  error: {
    label: 'Error',
    icon: <AlertTriangle className="text-[var(--danger)]" size={16} />,
  },
  retrying: {
    label: 'Retrying',
    icon: <Loader2 className="text-[var(--warning)] animate-spin" size={16} />,
  },
  quarantined: {
    label: 'Quarantined',
    icon: <AlertTriangle className="text-[var(--warning)]" size={16} />,
  },
};
