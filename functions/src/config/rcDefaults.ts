...
export const RC_DEFAULTS = {
  ...
  [RC_KEYS.embeddingModelName]: "gemini-embedding-2",
  [RC_KEYS.embeddingDimensions]: "2048",
  [RC_KEYS.embeddingLocationId]: "global",
  ...
  [RC_KEYS.importArchiveMaxExpandedBatchBytes]: "2147483648",
  [RC_KEYS.importArchiveMaxEntryBytes]: "268435456",
  [RC_KEYS.importArchiveMaxCompressionRatio]: "100",
  [RC_KEYS.importArchiveMaxPathBytes]: "1024",
  [RC_KEYS.importInlineZipBytes]: "157286400",
  [RC_KEYS.importMaxSourceBytes]: "536870912",
  [RC_KEYS.enrichmentRetrySeconds]: "300,1800,7200",
  [RC_KEYS.jevEnrichmentEnabled]: "false",
  [RC_KEYS.jevModelName]: "jev-1.13.0",
  [RC_KEYS.jevNoulThreshold]: "0.5",
  [RC_KEYS.jevMoodThreshold]: "0.7",
  [RC_KEYS.jevSearchIntentEnabled]: "false",
  [RC_KEYS.jevSearchRerankEnabled]: "false",
  [RC_KEYS.jevVerifyEnabled]: "false",
  [RC_KEYS.jevPairingEnabled]: "false",
  [RC_KEYS.jevMergeSuggestEnabled]: "false",
  [RC_KEYS.jevIntentConfidenceMin]: "0.5",
} as const;
