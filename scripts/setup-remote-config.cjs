...
const RC_KEYS = {
  ...
  // Batch enrichment (all-batch lane)
...
const RC_DEFAULTS = {
  ...
  // Rebuilt AI pipeline (Firestore vector index caps at 2048 dims)
  ...
  // Batch enrichment (gemini-3.5-flash batch is served from `global`)
